...
public class DBLoader {
    ...
    public void loadMaterialToDB(List<Material> matList, List<Integer> idUpdatedList, List<Integer> idDeletedList, int countOfInserted) throws SQLException {
    ...
    public void loadOrdersToDB(List<Orders> ordList, List<Integer> idUpdatedList, List<Integer> idDeletedList, int countOfInserted) throws SQLException {
/*
        if (idUpdatedList != null)
    ...
    public void loadDetailToDB(List<Details> detList, List<Integer> idUpdatedList, List<Integer> idDeletedList, int countOfInserted) throws SQLException {
/*
        if (idUpdatedList != null)
    ...
    public void loadToDB(List<Orders> ordList, List<Integer> idUpdOrd, List<Integer> idDelOrd, int countOfInsOrd,
                         ...
                         List<Details> detList, List<Integer> idUpdDet, List<Integer> idDelDet, int countOfInsDet) throws SQLException {
